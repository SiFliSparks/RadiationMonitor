...
RT_USED const struct sec_configuration sec_config =
{
    ...
    .imgs[DFU_FLASH_IMG_IDX(DFU_FLASH_IMG_HCPU)] = {.length = 0x000A79E8, .blksize = 512, .flags = DFU_FLAG_AUTO},
    ...
    .imgs[DFU_FLASH_IMG_IDX(DFU_FLASH_IMG_HCPU2)] = {.length = 0x000A79E8, .blksize = 512, .flags = DFU_FLAG_AUTO},
